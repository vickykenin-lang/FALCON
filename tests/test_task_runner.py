...
class TaskRunnerTests(unittest.TestCase):
    ...
    def test_github_write_acceptance_profile_is_sandboxed_governed_and_exact(self):
        task={"context":{"repository":"owner/repo","path":"artifacts/kra1/canary.txt","content":"safe canary\n","message":"KRA1 test"}}
        ...
        self.assertEqual(action["args"]["path"],"artifacts/kra1/canary.txt"); self.assertEqual(action["args"]["content"],"safe canary\n")
