...
class BrainDriver:
    ...
    def run(self,mission:Mission,context:dict|None=None)->Mission:
        ...
        while replans<=self.max_replans:
            ...
            verification=Event("RESULT","autonomic_driver",{"ok":all_ok,"evidence":evidence,"success_criteria":plan.get("success_criteria",[])},target="autonomic",correlation_id=mission.mission_id); self.runtime.bus.publish(verification)
